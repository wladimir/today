      ...
      <div class="flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0" style="height: 500px">
        <div class="flex flex-col w-full md:w-1/2 p-4">
          <div class="flex flex-col flex-1 justify-center mb-8">
            <h1 class="text-4xl text-center font-serif">Welcome Back</h1>
            <div class="w-full mt-4">
              <form class="form-horizontal w-3/4 mx-auto" method="POST" action="#">
                ...
                <div class="flex flex-col mt-4">
                  <input
                    id="password"
                    type="password"
                    class="flex-grow h-8 px-2 rounded border border-blue-600"
                    name="password"
                    required
              ...
              <div class="text-center mt-4">
                <p class="no-underline hover:underline text-blue-dark text-xs">Forgot Your Password?</p>
              </div>
            </div>
          </div>
        </div>
...
<style lang="postcss">
  .test {
    /* Example tailwind @apply */
    @apply bg-blue-500 text-orange-100;
  }
</style>
